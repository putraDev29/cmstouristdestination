<template>
  <div>
    ...
    <div class="container" style="margin-top: 90px; max-width: 800px;">
      <h6 class="text-center fw-bold mb-4">Add Tourist Destination</h6>
          ...
          <form @submit.prevent="submitForm">
            ...
            <div class="row mb-3">
              <div class="offset-sm-3 col-sm-9">
                <button type="submit" class="btn btn-primary w-100 fw-bold">Save Destination</button>
              </div>
            </div>
          </form>
        </div>
...
const {
  ...
  loadAccommodations,
  loadFacility
} = useDestination(false, null, true)
